        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" wire:submit.prevent="save" method="POST">
                        <div>
                            <label for="email"
                        ...
                        <div>
                            ...
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('email')text-red-700 dark:text-red-500 @enderror">Your
                            password</label>
                            <input type="password" name="pass" wire:model.defer="password" id="email"
                            class="
                            bg-gray-700 border text-white   rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="remember" aria-describedby="remember" type="checkbox" wire:model='RememberMe'
