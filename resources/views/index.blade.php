<x-layout class="bg-gray-600">
    <section class="bg-gray-900  justify-center item-center">
        <!-- Hero -->
        <div
            class=" h-90-v relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/squared-bg-element.svg')] dark:before:bg-[url('https://preline.co/assets/svg/examples-dark/squared-bg-element.svg')] before:bg-no-repeat before:bg-top before:size-full before:-z-[1] before:transform before:-translate-x-1/2">
            <div class="mt-9 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
                <!-- Announcement Banner -->
                <div class="flex justify-center">
                    <a class="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-xs text-gray-600 p-2 px-3 rounded-full transition hover:border-gray-300 focus:outline-none focus:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:hover:border-neutral-600 dark:focus:border-neutral-600"
                        href="#">
                        Discover TaskMaster Pro

                        <span class="flex items-center gap-x-1">
                            <span
                                class="border-s border-gray-200 text-blue-600 ps-2 dark:text-blue-500 dark:border-neutral-700">Learn
                                More</span>
                ...
                <div class="mt-5 max-w-3xl text-center mx-auto">
                    <p class="text-lg text-gray-600 dark:text-neutral-400">TaskMaster Pro helps you manage your tasks,
                        deadlines, and projects efficiently, all in one place. Experience seamless collaboration and
        ...
        <!-- Features -->
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" data-aos="zoom-in-down">
            <!-- Grid -->
                    ...
                    <div class="space-y-6 sm:space-y-8">
                        ...
                        <div class="space-y-2 md:space-y-4">
                            <h2 class="font-bold text-3xl lg:text-4xl text-gray-800 dark:text-neutral-200">
                                We Make The Earch Better Place
                            </h2>
                            <p class="text-gray-500 dark:text-neutral-500">
                                TaskMaster Pro helps you manage your tasks,
                                deadlines, and projects efficiently, all in one place. Experience seamless collaboration
                                and
        ...
        <section class="mt-5">
            <h1 class="text-center text-4xl text-gray-50" data-aos="fade-right" data-aos-delay="100">Our Team</h1>
            <p class="text-center text-gray-500 capitalize" data-aos="fade-right" data-aos-delay="300">they Are Cool And
                Brave People Who Work In This Project</p>
            ...
            <div class="max-w-6xl mx-auto mt-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <div data-aos="zoom-in" data-aos-delay="300"
                        class=" bg-gray-800 rounded-xl overflow-hidden shadow-lg transition-all duration-700  hover:scale-105 ease-in-out transform hover:shadow-2xl">
                        <div class="relative">
                            <img class="w-full h-64 object-cover"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV-UrYIzs2u3MPXTvIPUHNbHhH-jdy_Z04Ig&s6"
                                alt="John Doe">
                            <div
                                class="absolute inset-0 bg-black bg-opacity-20 transition-opacity duration-300 opacity-0 hover:opacity-100">
                            </div>
                        </div>
                        <div class="p-4 text-center">
                            <h2 class="text-xl font-bold text-gray-100 mb-2">Mohammedpro</h2>
                    ...
                    <div data-aos="zoom-in" data-aos-delay="500"
                        class="bg-gray-800 rounded-xl overflow-hidden shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-2xl">
                        <div class="relative">
                            <img class="w-full h-64 object-cover"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV-UrYIzs2u3MPXTvIPUHNbHhH-jdy_Z04Ig&s"
                                alt="Jane Smith">
                            <div
                                class="absolute inset-0 bg-black bg-opacity-20 transition-opacity duration-300 opacity-0 hover:opacity-100">
                            </div>
                        ...
                        <div class="p-4 text-center">
                            <h2 class="text-xl font-bold text-gray-100 mb-2">Mohammedpro</h2>
                            <p class="text-gray-400">Cool Guy</p>
                        </div>
                    </div>
                    ...
                    <div data-aos-delay="700" data-aos="zoom-in"
                        ...
                        <div class="p-4 text-center">
                            <h2 class="text-xl font-bold text-gray-100 mb-2">Mohammedpro</h2>
                            <p class="text-gray-400">Front End Developr</p>
                        </div>
                    </div>

                    <!-- Team Member 4 -->
                    <div data-aos-delay="900" data-aos="zoom-in"
                        class="bg-gray-800 rounded-xl overflow-hidden shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-2xl">
                        <div class="relative">
                            <img class="w-full h-64 object-cover"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV-UrYIzs2u3MPXTvIPUHNbHhH-jdy_Z04Ig&s"
                ...
                <div class="overflow-hidden">
                    <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <!-- Card 1 -->
                            <div data-aos="fade-right" data-aos-delay="300" class="flex h-auto">
                                <div class="flex flex-col bg-white rounded-xl dark:bg-neutral-900">
                                    <div class="flex-auto p-4 md:p-6">
                                        <p class="text-base italic md:text-lg text-gray-800 dark:text-neutral-200">
                                            "This task manager has streamlined our workflow. The intuitive interface and features are perfect for keeping our projects on track."
                                        </p>
                                    </div>
                            ...
                            <!-- Card 2 -->
                            <div data-aos="fade-up-right"data-aos-delay="500"  class="flex h-auto">
                                <div class="flex flex-col bg-white rounded-xl dark:bg-neutral-900">
                                    <div class="flex-auto p-4 md:p-6">
                                        <p class="text-base italic md:text-lg text-gray-800 dark:text-neutral-200">
                                            "Impressive tool with customizable workflows and integrations. It's significantly boosted our team's productivity."
                                        </p>
                                    </div>
                            ...
                            <!-- Card 3 -->
                            <div data-aos="fade-left" data-aos-delay="700" class="flex h-auto" >
                                <div class="flex flex-col bg-white rounded-xl dark:bg-neutral-900">
                                    <div class="flex-auto p-4 md:p-6">
                                        <p class="text-base italic md:text-lg text-gray-800 dark:text-neutral-200">
                                            "Excellent for task tracking and collaboration. The reporting features are incredibly useful for our team."
                                        </p>
                                    </div>
                        ...
                        <div class="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
                            ...
                            <div  data-aos="flip-up" data-aos-delay="600">
                                <h4 class="text-lg sm:text-xl font-semibold text-white">Users</h4>
                                <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">2,000+</p>
                                <p class="mt-1 text-gray-400">User Of TaskMaster</p>
                            </div>
                            <!-- End Stats -->

                            <!-- Stats -->
                            <div data-aos="flip-right" data-aos-delay="750">
